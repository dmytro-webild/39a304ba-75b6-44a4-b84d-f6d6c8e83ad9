    ...
    >
      ...
      <div id="hero" data-section="hero">
        <HeroLogoBillboard
          ...
          description="Ваше идеальное, уютное место на Восточке. Исключительно вкусно. Идеально чисто. Безупречный сервис без долгого ожидания. Средний чек: 5 000–10 000 ₸."
          buttons={[
